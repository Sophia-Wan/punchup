...
const garlandStars = [
  ...
  { x: 82.93, y: 60.82, scale: 1.4 },
  { x: 98.16, y: 51.98, scale: 1.54 },
  { x: 119.22, y: 33.85, scale: 1.2 },
  { x: 144.43, y: 48.59, scale: 1.15 },
  { x: 176.04, y: 54.59, scale: 1.2 },
  { x: 203.4, y: 54.59, scale: 2.45 },
  { x: 231.48, y: 55.59, scale: 1.25 },
  { x: 256.87, y: 61.13, scale: 1.35 },
  { x: 285.25, y: 44.66, scale: 0.95 },
  { x: 311.0, y: 59.18, scale: 1.25 },
  { x: 347.8, y: 55.55, scale: 1.35 },
  { x: 380.3, y: 43.65, scale: 2.0 },
  { x: 419.24, y: 60.82, scale: 1.35 },
  { x: 448.32, y: 40.64, scale: 1.0 },
  { x: 483.7, y: 47.02, scale: 1.2 },
  { x: 515.94, y: 59.18, scale: 1.35 },
